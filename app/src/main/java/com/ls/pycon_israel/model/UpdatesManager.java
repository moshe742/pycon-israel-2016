...
import com.ls.pycon_israel.model.data.UpdateDate;
import com.ls.pycon_israel.model.database.ILAPIDBFacade;
import com.ls.pycon_israel.model.managers.SynchronousItemManager;
...
public class UpdatesManager {
    ...
    private List<Integer> doPerformLoading() {
        ...
        BaseRequest checkForUpdatesRequest = new BaseRequest(BaseRequest.RequestMethod.GET, ApplicationConfig.BASE_URL + "checkUpdates.js", config);
